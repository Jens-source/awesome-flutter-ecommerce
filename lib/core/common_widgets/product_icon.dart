...
class CommonProductIcon extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return model.id == null
        ? Container(width: 5)
        : GetX<HomeController>(builder: (controller)=> GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: controller.selectedCategory == model.id
                        ...
                        : Colors.transparent,
                    border: Border.all(
                      color: controller.selectedCategory == model.id ? AppColors.orange : AppColors.grey,
                      width:controller.selectedCategory == model.id ? 2 : 1,
                    ),
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                        color: controller.selectedCategory == model.id ? const Color(0xfffbf2ef) : Colors.white,
                        blurRadius: 10,
                        spreadRadius: 5,
